...
(function($) {
    ...
    window.AIBotKitExport = {
         ...
         */
        config: {
            ajaxUrl: typeof aiBotKitChat !== 'undefined' ? aiBotKitChat.ajaxUrl : ajaxurl,
            nonce: typeof aiBotKitChat !== 'undefined' ? aiBotKitChat.nonce : '',
            isAdmin: typeof aiBotKitChat === 'undefined',
        },
