...
<div class="<?php echo esc_attr( $container_class ); ?>" id="<?php echo esc_attr( $chat_id ); ?>" data-widget="<?php echo $is_widget ? 'true' : 'false'; ?>">
	<div class="ai-botkit-chat">
		...
		<!-- Chat Messages (suggestions wrapper will be dynamically added after bot messages when recommendations are shown) -->
			...
			<div class="ai-botkit-message assistant">
				<div class="ai-botkit-message-content">
					<div class="ai-botkit-message-text">
						<?php
						// $greeting_output is set by Shortcode_Handler (placeholders + shortcodes already processed).
						echo wp_kses_post( isset( $greeting_output ) ? $greeting_output : __( 'Hello! How can I help you today?', 'knowvault' ) );
						?>
					</div>
				</div>
			</div>
	...
	<div class="ai-botkit-history-panel" aria-hidden="true" aria-label="<?php esc_attr_e( 'Chat History', 'knowvault' ); ?>">
		...
		<!-- Search (FR-210: Search in chat) -->
		<div class="ai-botkit-search-container ai-botkit-history-search-wrapper" role="search">
			<div class="ai-botkit-search-loading" aria-hidden="true" style="display: none;">
				<div class="ai-botkit-search-spinner"></div>
				<span class="ai-botkit-search-loading-text"><?php esc_html_e( 'Searching...', 'knowvault' ); ?></span>
			</div>
			<div class="ai-botkit-search-input-wrapper">
				<input type="search" class="ai-botkit-search-input" placeholder="<?php esc_attr_e( 'Search conversations...', 'knowvault' ); ?>" autocomplete="off" />
				<div class="ai-botkit-search-suggestions" aria-hidden="true"></div>
				<button type="button" class="ai-botkit-search-clear" aria-label="<?php esc_attr_e( 'Clear search', 'knowvault' ); ?>" style="display: none;">&times;</button>
			</div>
			<div class="ai-botkit-search-results" aria-live="polite"></div>
		</div>
