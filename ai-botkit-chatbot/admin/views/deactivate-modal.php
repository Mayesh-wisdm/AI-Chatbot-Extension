<div id="ai-botkit-deactivation-modal" class="ai-botkit-modal-overlay">
	<div class="ai-botkit-kb-modal">
		<div class="ai-botkit-modal-header">
			<h3><?php esc_html_e('Deactivate AI BotKit Plugin', 'ai-botkit-for-lead-generation'); ?></h3>
			<p><?php esc_html_e('Are you sure you want to deactivate AI BotKit Plugin? You will no longer be able to use the plugin and all your data will be lost.', 'ai-botkit-for-lead-generation'); ?></p>
		</div>
		<div class="ai-botkit-modal-body">
            <!-- <div class="ai-botkit-form-group">
                <label for="ai-botkit-deactivation-reason" class="ai-botkit-label"><?php esc_html_e('Reason for deactivation', 'ai-botkit-for-lead-generation'); ?></label>
                <div class="ai-botkit-radio-group">
                    <label>
                        <input type="radio" name="ai-botkit-deactivation-reason" value="no_longer_needed">
                        <?php esc_html_e('I no longer need the plugin', 'ai-botkit-for-lead-generation'); ?>
                    </label>
                    <label>
                        <input type="radio" name="ai-botkit-deactivation-reason" value="found_better_plugin">
                        <?php esc_html_e('I found a better plugin', 'ai-botkit-for-lead-generation'); ?>
                    </label>
                    <label>
                        <input type="radio" name="ai-botkit-deactivation-reason" value="couldn_t_get_it_to_work">
                        <?php esc_html_e('I couldn\'t get it to work', 'ai-botkit-for-lead-generation'); ?>
                    </label>
                    <label>
                        <input type="radio" name="ai-botkit-deactivation-reason" value="temporary_deactivation">
                        <?php esc_html_e('It is a temporary deactivation', 'ai-botkit-for-lead-generation'); ?>
                    </label>
                    <label>
                        ...
                        <?php esc_html_e('The functionality is not what I expected', 'ai-botkit-for-lead-generation'); ?>
                    </label>
                    <label>
                        <input type="radio" name="ai-botkit-deactivation-reason" class="ai-botkit-deactivation-reason-other" value="other">
                        <?php esc_html_e('Other', 'ai-botkit-for-lead-generation'); ?>
                    </label>
                </div>
            </div>
            ...
            <div class="ai-botkit-deactivation-reason-error">
                <?php esc_html_e('Please select a reason for deactivation', 'ai-botkit-for-lead-generation'); ?>
            </div> -->
		...
		<div class="ai-botkit-modal-footer">
            <button id="ai-botkit-cancel-deactivation" class="ai-botkit-btn-outline"><?php esc_html_e('Cancel', 'ai-botkit-for-lead-generation'); ?></button>
            <div class="ai-botkit-deactivation-buttons">
                <button id="ai-botkit-skip-deactivation" class="ai-botkit-btn-outline"><?php esc_html_e('Skip and deactivate', 'ai-botkit-for-lead-generation'); ?></button>
                <!-- <button id="ai-botkit-confirm-deactivation-submit" class="ai-botkit-btn ai-botkit-btn-primary"><?php esc_html_e('Submit and deactivate', 'ai-botkit-for-lead-generation'); ?></button> -->
            </div>
		</div>
	</div>
</div>