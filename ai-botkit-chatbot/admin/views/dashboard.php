	...
	<div class="ai-botkit-feature-grid">
		<div class="ai-botkit-feature-card">
			...
			<div class="ai-botkit-feature-wrapper">
				<h3>
					<?php if ($has_chatbots): ?>
						<?php esc_html_e('2. Manage your chatbots', 'knowvault'); ?>
					<?php else: ?>
						<?php esc_html_e('2. Create your first chatbot', 'knowvault'); ?>
					<?php endif; ?>
				</h3>
				<p class="ai-botkit-feature-desc">
					<?php if ($has_chatbots): ?>
						<?php esc_html_e('You have', 'knowvault'); ?> <strong><?php echo esc_html($total_chatbots); ?></strong> <?php echo $total_chatbots === 1 ? esc_html__('chatbot', 'knowvault') : esc_html__('chatbots', 'knowvault'); ?>. <?php esc_html_e('Manage them or create new ones', 'knowvault'); ?>
					<?php else: ?>
						<?php esc_html_e('Build a sitewide bot or add one to any page', 'knowvault'); ?>
					<?php endif; ?>
			...
			<a id="ai-botkit-get-started" class="ai-botkit-button-lg" href="<?php echo esc_url(admin_url('admin.php?page=ai-botkit&tab=chatbots' . ($has_chatbots ? '' : '&create=1'))); ?>">
				<?php if ($has_chatbots): ?>
					<?php esc_html_e('Manage Chatbots', 'knowvault'); ?>
				<?php else: ?>
					<?php esc_html_e('Create Your First Chatbot', 'knowvault'); ?>
				<?php endif; ?>
			</a>
		</div>
		<div class="ai-botkit-feature-card">
			<h3 class="ai-botkit-feature-title">
				<?php esc_html_e('Product Support', 'knowvault'); ?>
			</h3>
			<div class="ai-botkit-support-wrapper">
				...
				<div class="ai-botkit-support-wrapper-content">
					<h3><?php esc_html_e('Documentation', 'knowvault'); ?></h3>
					<p class="ai-botkit-feature-desc">
						<?php esc_html_e('Step by step guide and API reference', 'knowvault'); ?>
			...
			<div class="ai-botkit-support-wrapper">
				...
				<div class="ai-botkit-support-wrapper-content">
					<h3><?php esc_html_e('Email Support', 'knowvault'); ?></h3>
					<p class="ai-botkit-feature-desc">
						<?php esc_html_e('Reach us anytime at', 'knowvault'); ?>
						<a href="<?php echo esc_url("mailto:contact@aibotkit.io"); ?>" target="_blank">
							<?php esc_html_e('contact@aibotkit.io', 'knowvault'); ?>
						</a>
					</p>
				</div>
			</div>
			<div class="ai-botkit-support-wrapper">
				...
				<div class="ai-botkit-support-wrapper-content">
					<h3><?php esc_html_e('Ask Assistant', 'knowvault'); ?></h3>
					<p class="ai-botkit-feature-desc">
						<?php esc_html_e('Instant help from our AI assistant, trained on all our documentation', 'knowvault'); ?>
					</p>
				</div>
			</div>
		</div>
...
<div id="ai-botkit-activation-modal" class="ai-botkit-modal-overlay" style="display: <?php echo $is_first_install ? 'block' : 'block'; ?>;">
	<div class="ai-botkit-kb-modal">
		<div class="ai-botkit-modal-header">
			<h3><?php esc_html_e('Welcome to KnowVault Plugin', 'knowvault'); ?></h3>
			<p><?php esc_html_e('Thanks for activating the plugin. To personalize your experience and provide better support, we’d like to collect basic site and admin info. We do not collect any sensitive or customer data.', 'knowvault'); ?></p>
		</div>
		...
		<div class="ai-botkit-modal-footer">
			<button id="ai-botkit-cancel-activation" class="ai-botkit-btn-outline"><?php esc_html_e('Cancel', 'knowvault'); ?></button>
		</div>
	</div>
</div>
