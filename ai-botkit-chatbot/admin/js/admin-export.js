...
(function($) {
    ...
    window.AIBotKitAdminExport = {
         ...
         */
        bindEvents: function() {
            // Single PDF export button (both old and new class names)
            $(document).on('click', '.ai-botkit-export-single-pdf, .ai-botkit-export-pdf-btn', this.handleSingleExport.bind(this));

            // Single CSV export button
            $(document).on('click', '.ai-botkit-export-csv-btn', this.handleSingleCsvExport.bind(this));
        ...
        exportSingle: function(conversationId, $btn) {
            ...
            $form.append($('<input>', { type: 'hidden', name: 'nonce', value: ai_botkitAdmin.nonce }));
        ...
        /**
         * Handle single conversation CSV export
         *
         * @param {Event} e Click event
         */
        handleSingleCsvExport: function(e) {
            e.preventDefault();
            ...
            this.exportSingleCsv(conversationId, $btn);
        },
         ...
         * @param {jQuery} $btn Button element
         */
        exportSingleCsv: function(conversationId, $btn) {
            const self = this;
            const originalHtml = $btn.html();
            ...
            $form.append($('<input>', { type: 'hidden', name: 'action', value: 'ai_botkit_export_csv' }));
            $form.append($('<input>', { type: 'hidden', name: 'nonce', value: ai_botkitAdmin.nonce }));
            $form.append($('<input>', { type: 'hidden', name: 'conversation_id', value: conversationId }));
            $form.append($('<input>', { type: 'hidden', name: 'include_metadata', value: 'true' }));
